...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <title>{{ __('PowerPay') }}</title>
    <link rel="apple-touch-icon" sizes="76x86" href="{{ asset('material') }}/img/bank.png">
    <link rel="icon" type="image/png" href="{{ asset('material') }}/img/bank.png">
