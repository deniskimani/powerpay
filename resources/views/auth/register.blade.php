          ...
          <div class="card-body ">
            ...
            <div class="bmd-form-group{{ $errors->has('role') ? ' has-danger' : '' }} ">
              <div class="input-group">
                ...
                <input type="text" name="role" class="form-control" placeholder="{{ __('Role...') }}" value="{{ old('role') }}" required>
              </div>
              @if ($errors->has('role'))
            ...
            <div class="bmd-form-group{{ $errors->has('phone_number') ? ' has-danger' : '' }}">
              <div class="input-group">
                ...
                <input type="number" name="phone_number" class="form-control" placeholder="{{ __('Phone...') }}" value="{{ old('phone_number') }}" required>
              </div>
